<div class="app-menu navbar-menu">
            <div class="navbar-brand-box">
                ...
                <a href="index.html" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?= media(); ?>/img/logo-sm.png" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?= media(); ?>/img/logo-dark.png" alt="" height="17">
                    </span>
                </a>
                <!-- Light Logo-->
                <a href="index.html" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="<?= media(); ?>/img/logo-light.png" alt="" height="17">
                    </span>
                </a>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?= base_url(); ?>/Dashboard/">&nbsp;&nbsp;
                                <i class=" ri-home-4-fill icon-home"></i> <span data-key="home">Inicio</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#users" data-bs-toggle="collapse" role="button"
                                ...
                                <i class="ri-group-fill icon-usuarios"></i> <span data-key="usuarios">Usuarios</span>
                            </a>
                            <div class="collapse menu-dropdown" id="users">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/Usuarios/" class="nav-link" data-key="users"> 
                                        <i class="ri-group-line"></i> Usuarios
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/Roles/" class="nav-link" data-key="roles"> 
                                        <i class="ri-open-arm-line"></i> Roles
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/P ermisos/" class="nav-link" data-key="permisos"> 
                                        <i class="ri-key-2-line"></i> Permisos
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#configuracion" data-bs-toggle="collapse" role="button"
                                aria-expanded="false" aria-controls="configuracion">
                                <i class="ri-settings-5-line icon-settings"></i> <span data-key="t-base-ui">Configuraci&oacute;n</span>
                            </a>
                            <div class="collapse menu-dropdown mega-dropdown-menu" id="configuracion">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <ul class="nav nav-sm flex-column">                                            
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-tipo-intercambio">Tipo de Intercambio</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-tipo-movilidad">Tipo de Movilidad</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-tipo-estancia">Tipo de Estancia</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-grado-academico">Grado Acad&eacute;mico</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-etapa-formativa">Etapa formativa</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-periodos">Per&iacute;odos</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-periodos-intercambio">Per&iacute;odos Intercambio</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-semestres">Semestres</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-4">
                                        <ul class="nav nav-sm flex-column">                                            
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-genero">G&eacute;nero</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-estado-civil">Estado Civil</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-vives-con">Vives con</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-idiomas">Idiomas</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-material-pisos">Material pisos</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-tienes-casa">Tienes en casa</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-duracion-estancia">Duraci&oacute;n estancia</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-beca">Beca</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-4">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-campus">Campus</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-UA">Unidades Acad&eacute;micas</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-carreras">Carreras</a>
                                            </li>      
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-pais">Pa&iacute;s</a>
                                            </li>       
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-universidades">Universidades</a>
                                            </li>    
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-casa-vives">Casa donde vives</a>
                                            </li> 
                                            <li class="nav-item">
                                                <a href="#" class="nav-link" data-key="t-transporte">Transporte</a>
                                            </li>                               
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#">&nbsp;&nbsp;
                                <i class="ri-login-box-line icon-exit"></i> <span data-key="salir">Salir</span>
                            </a>
                        </li>
